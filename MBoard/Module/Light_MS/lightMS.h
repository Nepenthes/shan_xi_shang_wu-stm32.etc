...
//IO方向设置
#define TSLSDA_IN()  {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL |= 0x80000000;}
#define TSLSDA_OUT() {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL |= 0x30000000;}

//IO操作函数	 
#define TSLIIC_SCL    PBout(6) //SCL
#define TSLIIC_SDA    PBout(7) //SDA	 
#define TSLREAD_SDA   PBin(7)  //SDA 
